# Mobile "También ofrezco" — full service list

## Direction
The mobile "También ofrezco" section previously showed only 2 related services (matching `relatedServiceIds`). User requested it list **all** services the website offers, matching the app-like mobile design language.
