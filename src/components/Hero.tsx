...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-background via-background to-secondary/35" />
      <div className="absolute -top-44 -left-44 h-[24rem] w-[24rem] rounded-full bg-secondary/60 blur-[120px]" />
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="order-1 md:order-2 flex justify-center">
            <div className="relative">
              <div className="relative cafe-panel overflow-hidden p-3 max-w-sm mx-auto bg-card">
                <img
