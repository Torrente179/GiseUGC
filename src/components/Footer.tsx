          ...
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
            <div>
              ...
              <ul className="space-y-3.5 text-sm">
                ...
                <li><a href="#services" className="text-white/50 hover:text-white transition-colors">{t('services.service3.title')}</a></li>
                <li><a href="#services" className="text-white/50 hover:text-white transition-colors">{t('services.service4.title')}</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3.5 text-sm">
                ...
                <li><a href="#portfolio" className="text-white/50 hover:text-white transition-colors">{t('navbar.portfolio')}</a></li>
                <li><a href="#testimonials" className="text-white/50 hover:text-white transition-colors">{t('navbar.testimonials')}</a></li>
                <li><a href="#contact" className="text-white/50 hover:text-white transition-colors">{t('navbar.contact')}</a></li>
              </ul>
            </div>
