        ...
        <div className="grid gap-8 lg:gap-10 xl:grid-cols-[minmax(0,0.5fr)_minmax(0,0.5fr)] xl:items-start mb-8">
          <div>
            ...
            <div className="hidden md:flex gap-3 mt-7">
              ...
              <a href={facebookUrl} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="h-12 w-12 rounded-full border border-foreground/15 bg-foreground/5 flex items-center justify-center text-foreground/70 hover:bg-accent hover:text-accent-foreground transition-all duration-300">
