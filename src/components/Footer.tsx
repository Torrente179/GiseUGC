        ...
        <div className="grid gap-8 lg:gap-10 xl:grid-cols-[minmax(0,0.5fr)_minmax(0,0.5fr)] xl:items-start mb-8">
          <div>
            ...
            <div className="flex gap-3 mt-7">
              ...
              <button type="button" aria-label="Twitter" className="h-11 w-11 rounded-full border border-foreground/15 bg-foreground/5 flex items-center justify-center text-foreground/70 hover:bg-accent hover:text-accent-foreground transition-all duration-300">
                <Twitter className="h-5 w-5" />
              </button>
              <button type="button" aria-label="LinkedIn" className="h-11 w-11 rounded-full border border-foreground/15 bg-foreground/5 flex items-center justify-center text-foreground/70 hover:bg-accent hover:text-accent-foreground transition-all duration-300">
                <Linkedin className="h-5 w-5" />
              </button>
              <button type="button" aria-label="Facebook" className="h-11 w-11 rounded-full border border-foreground/15 bg-foreground/5 flex items-center justify-center text-foreground/70 hover:bg-accent hover:text-accent-foreground transition-all duration-300">
