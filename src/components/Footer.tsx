    ...
    <footer id="contact" className="bg-[#F6F3EE] text-foreground pt-12 md:pt-14 pb-8 md:pb-10">
      <div className="studio-container">
        <div className="grid gap-8 lg:gap-10 xl:grid-cols-[minmax(0,0.5fr)_minmax(0,0.5fr)] xl:items-start mb-8">
          <div>
            <h3 className="brand-logo text-[clamp(2.25rem,4.5vw,3.75rem)] leading-[0.95] mb-4 text-foreground">
            ...
            <div className="hidden md:flex gap-3 mt-7">
              <button type="button" aria-label="Instagram" className="h-12 w-12 rounded-full border border-foreground/15 bg-foreground/5 flex items-center justify-center text-foreground/85 hover:bg-accent hover:text-accent-foreground transition-all duration-300">
                <Instagram className="h-5 w-5" />
              </button>
              <button type="button" aria-label="Twitter" className="h-12 w-12 rounded-full border border-foreground/15 bg-foreground/5 flex items-center justify-center text-foreground/85 hover:bg-accent hover:text-accent-foreground transition-all duration-300">
                <Twitter className="h-5 w-5" />
              </button>
              <button type="button" aria-label="LinkedIn" className="h-12 w-12 rounded-full border border-foreground/15 bg-foreground/5 flex items-center justify-center text-foreground/85 hover:bg-accent hover:text-accent-foreground transition-all duration-300">
                <Linkedin className="h-5 w-5" />
              </button>
              <button type="button" aria-label="Facebook" className="h-12 w-12 rounded-full border border-foreground/15 bg-foreground/5 flex items-center justify-center text-foreground/85 hover:bg-accent hover:text-accent-foreground transition-all duration-300">
          ...
          <div>
            ...
            <div className="grid grid-cols-[auto_1fr] gap-3.5 md:gap-4 items-start">
              ...
              <div>
                <p className="text-[1.7rem] md:text-[1.95rem] leading-none font-semibold tracking-tight text-foreground">
                  ...
                  <span className="text-foreground/72 font-normal text-[1.5rem] md:text-[1.7rem]">
                ...
                <div className="mt-1.5 flex items-center gap-2.5 text-foreground/85">
                  ...
                  <span className="text-xl text-foreground/72 leading-none">(158)</span>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-x-4 gap-y-1 mt-2.5 text-foreground/82">
                  ...
                  {fiverrRatingDistribution.map((item) => {
                    ...
                    return (
                      <div key={item.stars} className="grid grid-cols-[2.2rem_1fr_auto] items-center gap-2.5">
                        <span className={`text-sm ${muted ? 'text-foreground/58' : 'text-foreground/82'}`}>{item.stars}★</span>
                        ...
                        <span className={`text-sm ${muted ? 'text-foreground/58' : 'text-foreground/82'}`}>({item.count})</span>
                      </div>
                    );
                  })}
                </div>
                ...
                <div className="space-y-2.5">
                  {fiverrRatingBreakdown.map((item) => (
                    <div key={item.labelKey} className="flex items-center justify-between text-sm">
                      <span className="text-foreground/76">{t(item.labelKey)}</span>
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 mt-4 text-xs uppercase tracking-[0.14em] font-bold text-foreground/90 hover:text-primary transition-colors"
            >
        ...
        <div className="border-t border-foreground/15 pt-8 text-center">
          <p className="text-xs text-foreground/78 tracking-wider">
