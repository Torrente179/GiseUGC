        ...
        <div className="relative h-full flex flex-col pt-24 px-8">
          ...
          >
            <a
              href="#contact"
              onClick={closeMobileMenu}
              className="btn-primary-nordic flex items-center gap-3 w-full py-4 px-8 text-lg rounded-2xl shadow-sm hover:scale-[1.01] active:scale-[0.99]"
            >
              {t('navbar.hireMe')}
            ...
            <div className="hidden md:flex items-center space-x-8">
              {navLinkKeys.map((link) => (
                <a
                  key={link.key}
                  href={link.href}
                  className="section-label text-foreground hover-lift hover:text-primary transition-all"
                >
                  {t(link.key)}
                </a>
              ))}
              ...
              <a
                href="#contact"
                className="btn-primary-nordic px-6 py-2.5 text-sm hover-grow btn-press shadow-sm ml-2"
              >
                {t('navbar.hireMe')}
              </a>
            </div>
