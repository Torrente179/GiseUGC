...
const FloatingContactDock = () => {
  ...
  return (
    <>
      <div
        className="fixed right-6 bottom-6 z-[130] hidden flex-col gap-2.5 pointer-events-none md:flex"
        style={{
      ...
      >
        <a
          ...
          className="group pointer-events-auto inline-flex items-center justify-center rounded-full border border-border/75 bg-card/90 px-4 py-2.5 backdrop-blur-md shadow-[0_24px_44px_-34px_hsl(var(--foreground)/0.8)] transition-all duration-300 hover:-translate-y-0.5 hover:border-foreground/20 hover:bg-card"
        >
          ...
          <span className="ml-2 section-label text-foreground/80 group-hover:text-foreground">
      ...
      <div
        className="fixed right-4 bottom-4 z-[130] flex flex-col gap-2.5 pointer-events-none md:hidden"
        style={{
