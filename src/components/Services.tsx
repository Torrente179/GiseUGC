        ...
        <div className="grid grid-cols-2 gap-4 md:gap-6 lg:grid-cols-3">
          {serviceData.map((service, index) => (
            <motion.article
              ...
              className="group rounded-[1.25rem] md:rounded-[1.5rem] border border-border/70 bg-card/50 p-5 md:p-8 backdrop-blur-md transition-shadow duration-500 hover:border-primary/30 hover:shadow-xl"
            >
