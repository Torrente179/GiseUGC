...
export const LEGACY_REEL_CLIPS: ReelClip[] = [
  {
    ...
    hlsSrc: r2HlsMaster('ugc-lifestyle-review.mp4'),
  ...
  },
  {
    ...
    hlsSrc: r2HlsMaster('ugc-brand-spokesperson.mp4'),
  ...
  },
  {
    ...
    hlsSrc: r2HlsMaster('ugc-voicebot-review.mp4'),
  ...
  },
  {
    ...
    hlsSrc: r2HlsMaster('ugc-creatine-supplement-review.mp4'),
  ...
  },
  {
    ...
    hlsSrc: r2HlsMaster('ugc-business-promotion.mp4'),
  ...
  },
  {
    ...
    hlsSrc: r2HlsMaster('ugc-services-presentation.mp4'),
  ...
  },
  {
    ...
    hlsSrc: r2HlsMaster('ugc-ai-services-review.mp4'),
  ...
  },
  {
    ...
    hlsSrc: r2HlsMaster('ugc-lifestyle-review-2.mp4'),
  ...
  },
  {
    ...
    hlsSrc: r2HlsMaster('ugc-voiceover-bots-review.mp4'),
  ...
  },
  {
    ...
    hlsSrc: r2HlsMaster('ugc-lifestyle-review-3.mp4'),
